...
//	}
    ...
    @Test
    public void testWinningConditionRow() throws CellAlreadyMarkedException {
    ...
    @Test
    public void testWinningConditionCol() throws CellAlreadyMarkedException {
      
        board.getCell(0, 0).setMark(MarkType.O);
        board.getCell(1, 0).setMark(MarkType.O);
