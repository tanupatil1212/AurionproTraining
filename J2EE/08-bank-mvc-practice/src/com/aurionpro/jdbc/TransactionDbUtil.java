...
//	public int getAccountNumberForUser(int user_id) {
//	    int accountNo = 0;
...
//
//	    try {
//	        // Get a database connection (replace with your DataSource setup)
//	        connection = dataSource.getConnection();
//
//	        // SQL query to retrieve the account number for the user
//	        String sql = "SELECT account_no FROM users WHERE user_id = ?";
//
...
//	    public static List<Transaction> getUserTransactionsByDate(int user_id, String startDate, String endDate) {
...
//	        try {
//	            conn = dataSource.getConnection();
//	            String sql = "SELECT trans_id, account_no, transaction_type_id, transaction_time, description, amount " +
//	                    "FROM transactions " +
//	                    "INNER JOIN accounts ON transactions.account_no = accounts.accountno " +
//	                    "INNER JOIN users ON accounts.userid = users.user_id " +
//	                    "WHERE users.user_id = ? " +
